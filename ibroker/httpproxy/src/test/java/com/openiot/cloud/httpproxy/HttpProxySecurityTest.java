...
public class HttpProxySecurityTest {
  ...
  @Autowired private HttpProxyServer httpProxyServer;
  @Mock private JmsMqClient fakeMQClient;
  @Mock private GenericCoapTcpServiceClient coapTcpClient;

  @Before
  public void setup() throws Exception {
    ConnectorPool.addConnection(
        "/meta",
        new IRequestChannel() {
          @Override
  ...
  public void testSecurityBasic() throws Exception {
    ...
    doAnswer(
        ...
        .defaultRequestHandle(
            isA(String.class), isA(RequestEntity.class), isA(DeferredResult.class), isA(Map.class));
