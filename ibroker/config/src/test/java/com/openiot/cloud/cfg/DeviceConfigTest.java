...
public class DeviceConfigTest {
  ...
  @Autowired ResProRepository resProRepo;
  ...
  public void setUp() {
    try {
      ...
      TestUtil.importTestDb(
          mongoTemplate, ConstDef.C_DEV, ConstDef.C_RES, ConstDef.C_RESPRO, ConstDef.C_TASKSRVREG);
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
  ...
  public void testDeviceConfig() {
    try {
      ...
      assertThat(devCfg.getLinks().get(0))
          .hasFieldOrPropertyWithValue("href", "/stepper")
          .hasNoNullFieldsOrPropertiesExcept("grp", "dl", "props", "project");
