 ...
 *
 * <p>You will have to create your context differently in a real world application.
 *
 ...
 *
 * <ul>
 *   <li>Enable client authentication on the server side by calling {@link
 *       SSLEngine#setNeedClientAuth(boolean)} before creating {@link SslHandler}.
 *   <li>When initializing an {@link SSLContext} on the client side, specify the {@link KeyManager}
 *       that contains the client certificate as the first argument of {@link
 *       SSLContext#init(KeyManager[], TrustManager[], SecureRandom)}.
 *   <li>When initializing an {@link SSLContext} on the server side, specify the proper {@link
 *       TrustManager} as the second argument of {@link SSLContext#init(KeyManager[],
 *       TrustManager[], SecureRandom)} to validate the client certificate.
 * </ul>
 */
