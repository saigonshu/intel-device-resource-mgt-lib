  ...
  public void testBasic() throws Exception {
    ...
    IConnectRequest request =
        IConnectRequest.create(
            ...
            UriComponentsBuilder.newInstance()
                ...
                .queryParam(ConstDef.Q_PROJECTID, projectDTO.getId())
                .build()
                .toString(),
            MediaType.APPLICATION_JSON,
            objectMapper.writeValueAsBytes(new String[] {iAgentIds[0], iAgentIds[1]}));
    ...
    doAnswer(
            invocation -> {
              ...
              GatewayDTO gatewayDTO =
                  objectMapper.readValue(response.getPayload(), GatewayDTO[].class)[0];
              assertThat(gatewayDTO)
                  .hasFieldOrPropertyWithValue("iAgentId", iAgentIds[0])
    ...
    doAnswer(
            invocation -> {
              ...
              GatewayDTO gatewayDTO =
                  objectMapper.readValue(response.getPayload(), GatewayDTO[].class)[0];
              assertThat(gatewayDTO)
                  .hasFieldOrPropertyWithValue("iAgentId", iAgentIds[2])
    ...
    doAnswer(
            invocation -> {
              ...
              GatewayDTO[] gatewayDTOs =
                  objectMapper.readValue(response.getPayload(), GatewayDTO[].class);
              assertThat(gatewayDTOs)
                  .hasSize(2)
                  .extracting("iAgentId")
                  .containsOnly(iAgentIds[0], iAgentIds[1]);
