...
public class ApiProjectAmqpHandlerTest {
  ...
  @Autowired private ApiProjectAmqpHandler handler;
  @Autowired private IConnect conn;
  @Autowired private IConnectService service;
  ...
  public void testProjectCfg() throws Exception {
    ...
    IConnectRequest request =
        IConnectRequest.create(
            HttpMethod.POST,
            ConstDef.U_PROJECT_CFG + String.format("?%s=%s", ConstDef.Q_PROJECT, project.getId()),
    ...
    request =
        IConnectRequest.create(
            ...
            ConstDef.U_PROJECT_CFG
                + String.format(
                    "?%s=%s&%s=%s", ConstDef.Q_PROJECT, project.getId(), ConstDef.Q_CFGS, "[cn_1]"),
            MediaType.APPLICATION_JSON,
            "".getBytes());
    request.setTokenInfo(ConstDef.MSG_KEY_USR, "admin");
    request.setTokenInfo(ConstDef.MSG_KEY_PRJ, project.getId());
    ...
    request =
        IConnectRequest.create(
            ...
            ConstDef.U_PROJECT_CFG
                + String.format(
                    "?%s=%s&%s=%s",
                    ConstDef.Q_PROJECT, project.getId(), ConstDef.Q_CFGS, "[    cn_2 , cn_3 ]"),
            MediaType.APPLICATION_JSON,
            "".getBytes());
    request.setTokenInfo(ConstDef.MSG_KEY_USR, "admin");
    request.setTokenInfo(ConstDef.MSG_KEY_PRJ, project.getId());
  ...
  public void testProjectAttr() throws Exception {
    ...
    IConnectRequest request =
        IConnectRequest.create(
            HttpMethod.POST,
            ConstDef.U_PROJECT_ATTR + String.format("?%s=%s", ConstDef.Q_PROJECT, project.getId()),
            MediaType.APPLICATION_JSON,
    ...
    request =
        IConnectRequest.create(
            ...
            ConstDef.U_PROJECT_ATTR
                + String.format(
                    "?%s=%s&%s=%s",
                    ConstDef.Q_PROJECT, project.getId(), ConstDef.Q_ATTRS, "[an_1]"),
            MediaType.APPLICATION_JSON,
            "".getBytes());
    request.setTokenInfo(ConstDef.MSG_KEY_USR, "admin");
    request.setTokenInfo(ConstDef.MSG_KEY_PRJ, project.getId());
    ...
    request =
        IConnectRequest.create(
            ...
            ConstDef.U_PROJECT_ATTR
                + String.format(
                    "?%s=%s&%s=%s",
                    ConstDef.Q_PROJECT, project.getId(), ConstDef.Q_ATTRS, "[    an_2 , an_3 ]"),
            MediaType.APPLICATION_JSON,
            "".getBytes());
    request.setTokenInfo(ConstDef.MSG_KEY_USR, "admin");
    request.setTokenInfo(ConstDef.MSG_KEY_PRJ, project.getId());
  ...
  public void testProjectUpdate() throws Exception {
    ...
    request =
        IConnectRequest.create(
            HttpMethod.PUT,
            ConstDef.U_PROJECT + String.format("?%s=%s", ConstDef.Q_ID, project.getId()),
            MediaType.APPLICATION_JSON,
    ...
    List<TaskNew> tasks =
        taskRepo.findByMonitorNameAndEventTypeAndTargetTypeAndTargetId(
            "CFG_MONITOR",
    ...
    projectRepository.deleteById(project.getId());
    taskRepo.removeByMonitorNameAndEventTypeAndTargetTypeAndTargetId(
        "CFG_MONITOR", ConstDef.EVENT_TYPE_CFG_SYNC, ConstDef.EVENT_TARGET_TYPE_PROJECT, "test_id");
  }
}
