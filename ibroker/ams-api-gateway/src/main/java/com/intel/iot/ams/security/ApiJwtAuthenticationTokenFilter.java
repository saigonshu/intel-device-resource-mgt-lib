...
public class ApiJwtAuthenticationTokenFilter extends GenericFilter {
  ...
  Logger logger = LoggerFactory.getLogger(ApiJwtAuthenticationTokenFilter.class);
  ...
  public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
    ...
    if (SecurityContextHolder.getContext().getAuthentication() != null) {
      logger.info(
          "previous filters have generated authentication {}",
    ...
    if (authHeader != null && authHeader.startsWith(tokenPrefix)) {
      ...
      if (!token.isEmpty()) {
        ...
        if (tokenContent != null && StringUtils.isNotBlank(tokenContent.getUser())) {
