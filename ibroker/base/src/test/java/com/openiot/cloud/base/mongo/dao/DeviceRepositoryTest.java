...
public class DeviceRepositoryTest {
  @Autowired TestUtilBase testUtil;
  ...
  public void testFilterCase1() throws Exception {
    ...
    assertThat(devices)
        ...
        .hasSize(2)
        .extracting("id")
        .contains("00000000-0000-0000-0000-000000000004", "00000000-0000-0000-0000-000000000005");
  ...
  public void testFilterCase2() throws Exception {
    ...
    assertThat(devices)
        ...
        .hasSize(2)
        .extracting("id")
        .contains("00000000-0000-0000-0000-000000000007", "00000000-0000-0000-0000-000000000008");
  }
}
