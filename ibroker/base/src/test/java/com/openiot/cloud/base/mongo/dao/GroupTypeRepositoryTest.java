  ...
  public void testFields() throws Exception {
    ...
    groupTypeList =
        groupTypeRepository.filter(
            ...
            Collections.emptyMap(),
            Collections.emptyMap(),
            Stream.of(ConstDef.F_DESCRIPTION, ConstDef.F_ATTRS).collect(Collectors.toList()),
            PageRequest.of(0, 10));
    System.out.println(groupTypeList);
    assertThat(groupTypeList)
        .hasSize(1)
    ...
    groupTypeList =
        groupTypeRepository.filter(
            ...
            Collections.emptyMap(),
            Collections.emptyMap(),
            Stream.of(ConstDef.F_DESCRIPTION, ConstDef.F_ATTRS, ConstDef.F_CONFIGS)
