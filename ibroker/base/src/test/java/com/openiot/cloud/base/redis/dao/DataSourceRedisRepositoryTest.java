  ...
  public void testBasic() throws Exception {
    ReferenceDefinitionRedis definition =
        new ReferenceDefinitionRedis(
            ...
            LocalDateTime.of(2000, 1, 2, 3, 5, 5).toInstant(ZoneOffset.UTC).toEpochMilli());
    ...
    dataSourceReferenceRedis.addDefinitionItem(
        new ReferenceDefinitionRedis(
            ...
            "/3303/0",
            "5602",
            baseTime + TimeUnit.MINUTES.toMillis(5),
            baseTime + TimeUnit.MINUTES.toMillis(10)));
    dataSourceReferenceRedis.addDefinitionItem(
        new ReferenceDefinitionRedis(
            "group_1",
            "data_source_1",
            ...
            "/3303/0",
            "5603",
            baseTime + TimeUnit.MINUTES.toMillis(15),
            baseTime + TimeUnit.MINUTES.toMillis(20)));
    dataSourceReferenceRedis.addDefinitionItem(
        new ReferenceDefinitionRedis(
            "group_1",
            "data_source_1",
            ...
            "/3303/0",
            "5604",
            baseTime + TimeUnit.MINUTES.toMillis(25),
            baseTime + TimeUnit.MINUTES.toMillis(30)));
    ...
    assertThat(dataSourceRedisRepository.findLatestDefinition("group_1", "data_source_1"))
        .hasFieldOrPropertyWithValue("propName", "5604");

    List<ReferenceDefinitionRedis> definitionRedisList =
        dataSourceRedisRepository.findDefinitionByTimeBetween(
            "group_1",
            "data_source_1",
            baseTime + TimeUnit.MINUTES.toMillis(10),
            baseTime + TimeUnit.MINUTES.toMillis(25));
