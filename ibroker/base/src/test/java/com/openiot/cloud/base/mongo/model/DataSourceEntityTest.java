...
public class DataSourceEntityTest {
  ...
  public void testGetDsRefByTimeBwtween() throws Exception {
            ...
            Stream.of(
                    new DataSourceEntity.Reference(
                        ...
                        LocalDateTime.of(2000, 1, 1, 0, 0, 0)
                            ...
                            .toEpochMilli(),
                        LocalDateTime.of(2000, 1, 1, 0, 9, 14)
                            .toInstant(ZoneOffset.UTC)
                            .toEpochMilli()),
                    new DataSourceEntity.Reference(
                        "74e182bd2873-m",
                        ...
                        LocalDateTime.of(2000, 1, 1, 0, 10, 0)
                            .toInstant(ZoneOffset.UTC)
                            .toEpochMilli(),
                        LocalDateTime.of(2000, 1, 1, 0, 13, 52)
                            .toInstant(ZoneOffset.UTC)
                            .toEpochMilli()),
                    new DataSourceEntity.Reference(
                        "74e182bd2873-m",
                        "/1/0",
                        "4",
                        LocalDateTime.of(2000, 1, 1, 0, 15, 0)
                            .toInstant(ZoneOffset.UTC)
                            .toEpochMilli(),
                        0))
    ...
    referenceList =
        ds.getReferenceByTimeBetween(
            LocalDateTime.of(2000, 1, 1, 0, 0, 0).toInstant(ZoneOffset.UTC).toEpochMilli(),
            LocalDateTime.of(2000, 1, 1, 0, 12, 0).toInstant(ZoneOffset.UTC).toEpochMilli());
    assertThat(referenceList)
        .hasSize(2)
        .extracting("dsri")
        .containsOnly(
            new ResAndResProID("74e182bd2873-m", "/1/0", "0"),
            new ResAndResProID("74e182bd2873-m", "/1/0", "2"));

    referenceList =
        ds.getReferenceByTimeBetween(
            LocalDateTime.of(1999, 12, 31, 23, 00, 0).toInstant(ZoneOffset.UTC).toEpochMilli(),
            LocalDateTime.of(2000, 1, 1, 0, 0, 0).toInstant(ZoneOffset.UTC).toEpochMilli());
    assertThat(referenceList)
        .hasSize(1)
        .extracting("dsri")
    ...
    referenceList =
        ds.getReferenceByTimeBetween(
            LocalDateTime.of(1989, 1, 1, 0, 0, 0).toInstant(ZoneOffset.UTC).toEpochMilli(),
            LocalDateTime.of(1989, 1, 2, 0, 0, 0).toInstant(ZoneOffset.UTC).toEpochMilli());
